<!-- 
    Zarządzanie słownikami - główny widok
    * ©Copyright 2019
    * Karol Osica
 -->
        ...
        <div class="col-sm-6">
            <div class="shadow-lg card border border-primary">
                <div class="card-header bg-light text-center">
                    <font size="5" class="text-dark">Dostępne słowniki</font>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        $('#dictA001').click(function() {
            ...
            $("#selectedDict").load("templates/ManageDictionaries/selectedDict_tpl.php?dict=A001", function(responseTxt, statusTxt, xhr) {
                if (statusTxt == "error")
        ...
        $('#dictA002').click(function() {
            ...
            $("#selectedDict").load("templates/ManageDictionaries/selectedDict_tpl.php?dict=A002", function(responseTxt, statusTxt, xhr) {
                if (statusTxt == "error")
                    alert("Błąd! Skontaktuj się z administratorem!");
            });
        ...
        $('#dictA003').click(function() {
            ...
            $("#selectedDict").load("templates/ManageDictionaries/selectedDict_tpl.php?dict=A003", function(responseTxt, statusTxt, xhr) {
                if (statusTxt == "error")
                    alert("Błąd! Skontaktuj się z administratorem!");
            });
        });
