...
/**
 * Edytowanie danych wybranego zadania
 * ©Copyright 2019
 * Karol Osica
 */
...
//przypisanie nowych danych do tablicy
$taskDetails = [
    'taskID' => $_POST['taskID'],
...
//Uaktualnienie danych zadania
$status =  Task::updateTask($db_connect, $taskDetails);

//Interpretacja wyników operacji, oraz komunikat dla użytkownika
if ($status) {
