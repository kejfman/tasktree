<?php
/**
 * Klasa umożliwiająca zarządzanie słownikami w aplikacji Task Tree
 * ©Copyright 2019
 * Karol Osica
 */
...
class Dictionary
{
    ...
    public static function addToDictionary(mysqli $db_connect, string $dict_id, string $dict_value)
    {
        ...
        if ($db_connect->query($insert_query)) {
            ...
            $infoLog['nok'][] = "Błąd podczas komunikacji z bazą danych, skontaktuj się z administratorem! - Dictionary::addToDictionary" . $db_connect->error;
            return $infoLog;
        }
    }
    ...
    public static function deleteValueDictionary(mysqli $db_connect, string $dict_content)
    {
        ...
        if ($db_connect->query($delete_query)) {
            ...
            $infoLog['nok'][] = "Błąd podczas komunikacji z bazą danych, skontaktuj się z administratorem! - Dictionary::deleteValueDictionary" . $db_connect->error;
            return $infoLog;
        }
    }
